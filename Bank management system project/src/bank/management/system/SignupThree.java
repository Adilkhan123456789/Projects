...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        add(c6);
         ...
         c7=new JCheckBox("I hereby declares that the above entered details are correct to the vest of my knowledge.");
        c7.setBackground(Color.WHITE);
        c7.setFont(new Font("Raleway", Font.BOLD,14));
        c7.setBounds(100,550,680,30);
        add(c7);
        ...
        Sumbit.setBounds(250,600,100,30);
