...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
       ...
       JLabel additionalDeatails = new JLabel("Page 2: Additionl Details " );
        additionalDeatails.setFont(new Font("Raleway", Font.BOLD, 22));
        additionalDeatails.setBounds(290,80,400,30);
        add(additionalDeatails);
